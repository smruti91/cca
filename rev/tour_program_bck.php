...
<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
            ...
            <div class="form-group">
                ...
                $plan_sql = "SELECT p.org_id,p.plan_id,p.actual_audit_startdate,p.actual_audit_endate,d.S_descr,i.ddo_code,i.institution_name FROM `cca_manageplan` p , `cca_departments` d , `cca_institutions` i WHERE p.dept_id=d.ID AND p.org_id = i.id AND p.dept_id= '".$res_query['Dept_ID']."'  ";
