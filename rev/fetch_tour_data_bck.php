<?php
  ...
  //exit;
   if(isset($_POST['action']) && $_POST['action']=='planName')
   {
      ...
      $org_id = $_POST['org_id'];
      $plan_sql = "SELECT plan_id,actual_audit_startdate as commencent_dt,actual_audit_endate as completion_dt FROM `cca_manageplan` WHERE  org_id =". $org_id;
      echo $plan_sql;exit;
